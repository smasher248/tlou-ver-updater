...
int main()
{
	...
	int lineNo = 0;
	std::fstream paramr("C:\\Users\\Callum Cruickshank\\Desktop\\CUSA00552\\ff.txt");
	std::string line;
	...
	paramr.close();
	std::ofstream paramw("C:\\Users\\Callum Cruickshank\\Desktop\\CUSA00552\\ff.txt" /*std::ofstream::app*/);
	if (!paramw)
	{
